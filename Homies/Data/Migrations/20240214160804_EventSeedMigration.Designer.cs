...
namespace Homies.Data.Migrations
{
    ...
    [Migration("20240214160804_EventSeedMigration")]
    partial class EventSeedMigration
    {
            ...
            modelBuilder.Entity("Homies.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 2, 9, 18, 8, 4, 564, DateTimeKind.Local).AddTicks(4941),
                            Description = "Seeded event via a EF Core migration.",
                            End = new DateTime(2024, 2, 16, 4, 8, 4, 564, DateTimeKind.Local).AddTicks(4981),
                            Name = "Seeded Event",
                            OrganiserId = "9a080fb7-aa06-4a2b-823a-fcfb7dc091ee",
                            Start = new DateTime(2024, 2, 14, 18, 8, 4, 564, DateTimeKind.Local).AddTicks(4979),
                            TypeId = 2
                        });
                });
